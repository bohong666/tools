...
# 第四步：创建修复后的 Dockerfile
log_info "第四步：创建修复后的 Dockerfile..."
...
# 第五步：创建 docker-compose.yml
log_info "第五步：创建 docker-compose.yml..."
