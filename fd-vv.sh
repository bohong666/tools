...
# Komari 探针优化版 v3.0 - 移除 proxy_protocol
# 完美兼容 Reality 协议
...
echo -e "${GREEN}(Komari 探针优化版 v3.0)${NC}"
echo -e "${GREEN}========================================${NC}"
...
echo -e "${BLUE}推荐: www.microsoft.com, www.apple.com, www.cloudflare.com, updates.cdn-apple.com${NC}"
...
echo -e "5. 实时监控日志: ${GREEN}journalctl -u xray -f${NC}"
echo ""
