...
###############################################################################
# Script Manager 环境变量修复脚本 v2 (更可靠版本)
# 用法: bash fix-env-v2.sh
###############################################################################
...
print(f"[INFO] JWT_SECRET: {jwt_secret[:20]}...")
print(f"[INFO] WEBHOOK_SECRET: {webhook_secret[:20]}...")
PYTHON_EOF
